        ...
        <header>
          <div className="flex justify-between items-start mb-2">
            <div className="flex items-center flex-1">
              <h2 className="text-lg md:text-xl font-bold text-black dark:text-white cursor-pointer">
                {post.title}
              </h2>
              {isOuterLink && (
                <ArrowTopRightOnSquareIcon className="mt-[0.5px] ml-1 w-5 min-w-[20px] h-5 text-blue-700 dark:text-blue-400" />
              )}
            </div>
            <time className="text-gray-600 dark:text-gray-400 text-sm ml-4 flex-shrink-0">
